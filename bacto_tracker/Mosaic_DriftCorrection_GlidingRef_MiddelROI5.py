...
SavingPath = Path('/mnt/grey/DATA/rawData_2021/Experiment_9_FTL_DeltaKill_20210218/011_FastTimeLapse_RAMM_Test/Segmented_images')
# StartingPath = Path('/mnt/grey/DATA/rawData_2020/Experiment_9_sara/Segmentation/Segmented_images/ROI_5/')
StartingPath = Path('/mnt/grey/DATA/rawData_2021/Experiment_9_FTL_DeltaKill_20210218/011_FastTimeLapse_RAMM_Test/Segmented_images/ROI_5')
...
#for file in range(100):
    ...
    shift, error, diffphase = phase_cross_correlation(ImgRef, Img)
...
filename = str(SavingPath)+'/XYshift_DriftCorr_ROI5_EcoliSegmentedBased.txt'
